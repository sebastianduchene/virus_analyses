...
# TITV
pdf('Fig1.pdf', useDingbats = F)
par(mfrow = c(2, 2))
par(mar = c(4, 4, 1, 1))
plot(log10(combine_dat$V12.x), combine_dat$V2.x, pch = 1:10, col = 'black', ylim = c(1, 20), xlim = c(1, 4), lwd = 1.5, ylab = 'Ti/Tv')
points(log10(combine_dat$V12.y), combine_dat$V2.y, pch = 1:10, col = 'red', lwd = 1.5)
legend(x = 3.2, y = 20, legend = names_data, bty = 'n', cex = 0.7, pch = 1:10)
...
# dnds
plot(log10(combine_dat$V12.x), combine_dat$V5.x, pch = 1:10, col = 'black', ylim = c(0, 2.5), xlim = c(1, 4), lwd = 1.5, ylab = 'dN/dS')
...
# alpha
plot(log10(combine_dat$V12.x), combine_dat$V6.x, pch = 1:10, col = 'black', ylim = c(0, 0.32), xlim = c(1, 4), lwd = 1.5, ylab = 'alpha')
...
# GC cont
plot(log10(combine_dat$V12.x), combine_dat$cg.x, pch = 1:10, col = 'black', ylim = c(0.6, 1.1), xlim = c(1, 4), lwd = 1.5, ylab = 'C-G content')
